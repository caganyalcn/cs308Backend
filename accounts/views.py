...
@permission_classes([AllowAny])   # herkes erişebilsin
def csrf_token(request):
    """
    Oturum olmasa da CSRF token üretir ve
    hem 'csrftoken' çerezi hem de JSON ile döner.
    """
    token = get_token(request)
    # Django CsrfViewMiddleware, get_token çağrısıyla
    # Set-Cookie: csrftoken=... header’ını otomatik ekler
